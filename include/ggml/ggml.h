...
extern "C" {
    ...
    GGML_API int64_t ggml_nelements_padded(const struct ggml_tensor * tensor);
    ...
    GGML_API struct ggml_tensor * ggml_add_and_trim(
            struct ggml_context * ctx,
            struct ggml_tensor  * a,
            struct ggml_tensor  * b,
            size_t                output_len);
    ...
    GGML_API struct ggml_tensor * ggml_add_and_tanh(
            struct ggml_context * ctx,
            struct ggml_tensor  * a,
            struct ggml_tensor  * b);

    GGML_API struct ggml_tensor * ggml_add_and_tanh_inplace(
            struct ggml_context * ctx,
            struct ggml_tensor  * a,
            struct ggml_tensor  * b);
    ...
    GGML_API struct ggml_tensor * ggml_special_adam_step(
            struct ggml_context * ctx,
    ...
    GGML_API void ggml_build_forward_no_expand (struct ggml_cgraph * cgraph, struct ggml_tensor * tensor);
